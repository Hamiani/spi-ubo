...
const studentActionsBuilder = {
  ...
  GET_FORMATIONS : {
    START : actions[StudentActionsTypes.GET_FORMATIONS.START],
    SUCCESS: actions[StudentActionsTypes.GET_FORMATIONS.SUCCESS],
    FAIL: actions[StudentActionsTypes.GET_FORMATIONS.FAIL],
  }
};
