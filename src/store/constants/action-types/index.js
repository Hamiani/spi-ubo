export { default as CommonActionTypes } from "./common";
export { default as AuthActionTypes } from "./auth";
export { default as FormationActionsTypes } from "./formation";
...
export { default as StudentActionsTypes } from "./student";
